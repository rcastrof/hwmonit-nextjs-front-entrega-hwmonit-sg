...
const ModalEditUrl = (props) => {

    const { show, onClose, name, version, id, editPackage } = props;
    ...
    const onSubmit = async (event) => {
        ...
        if (saveForm) {
            ...
            editPackage(id, package_name, package_version)
    ...
    useEffect(() => {
        ...
        setValue("package_version", version)

        return () => {
            setValue("package_name", "")
            setValue("package_version", "")
        }
    }, [show])
