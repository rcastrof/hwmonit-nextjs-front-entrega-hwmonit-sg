...
const ModalCreateNewUrl = (props) => {

    const { show, onClose, addNewProperty, isRepeat } = props;
    ...
    const onSubmit = async (event) => {
        ...
        if(isRepeat(keyName)){
            setError("key_name", {
                type: "repeat",
                message: "Nombre de la Propiedad repetido"
            })
            return
        }
        ...
        if (saveForm) {
            ...
            addNewProperty(key_name, value_name)
                                    ...
                                    <label className='text-[#FAFAFA] text-sm flex flex-col'>
                                        <div className='overflow-auto gt-scroll h-[310px]'>
                                            ...
                                            <input
                                                ...
                                                autoComplete="off" placeholder="Ingresa una clave" minLength={2} maxLength={100} autoFocus />
                                            ...
                                            <input
                                                {...register("value_name", {
                                                    required: { value: true, message: "* Campo Requerido" },
                                                    minLength: { value: 2, message: "* Campo debe tener 2 o mas de longitud" },
                                                    maxLength: { value: 200, message: "* Longitud Máxima de 200 caracteres" },
                                                })} name="value_name" type="text"
                                                className="ml-[24px] border-[2px] border-white/[0.20] bg-transparent rounded-[9px] w-[279px] h-[48px] pl-[16px] focus:outline-none focus-visible:ring-1 focus-visible:ring-white"
                                                autoComplete="off" placeholder="Ingresa un valor" minLength={2} maxLength={200} />
...
export default ModalCreateNewUrl;