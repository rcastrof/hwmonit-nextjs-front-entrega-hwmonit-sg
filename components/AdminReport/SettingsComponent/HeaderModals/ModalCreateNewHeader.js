...
const ModalCreateNewHeader = (props) => {

    const { show, onClose, addNewHeader, isRepeat } = props;
    ...
    const onSubmit = async (event) => {
        ...
        if(isRepeat(keyName)){
            setError("key_name", {
                type: "repeat",
                message: "Nombre del Header repetido"
            })
            return
        }
        ...
        if (saveForm) {
            ...
            addNewHeader(key_name, value_name);
                                    ...
                                    <label className='text-[#FAFAFA] text-sm flex flex-col'>
                                        <div className='overflow-auto gt-scroll h-[310px]'>
                                            ...
                                            <input
                                                ...
                                                className="ml-[24px] border-[2px] border-white/[0.20] bg-transparent rounded-[9px] w-[279px] h-[48px] pl-[16px] focus:outline-none focus-visible:ring-1 focus-visible:ring-white"
                                                autoComplete="off" placeholder="Ingresa un valor" minLength={2} maxLength={100} />
...
export default ModalCreateNewHeader;