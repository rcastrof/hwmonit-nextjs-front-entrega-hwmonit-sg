...
const ModalDelete = (props) => {
    ...
    const handleDelete = async () => {
            ...
            const listDetails = await new Promise((resolve, reject) => {
                axios.delete(`${process.env.REACT_APP_API_URL}deleteRol/${nameRol}`, { withCredentials: true })
                    .then(response => {
                        resolve(response);
                    ...
                    >
                        <div className="inline-block w-[327px] h-[246px] align-bottom bg-gradient-to-b from-[#003C61] to-[#1B6970] text-left  shadow-xl transform transition-all my-[6rem] m:my-[15rem] rounded-[1.875rem]">
                            ...
                            <div className="flex h-[120px] ml-[1rem] ">
                                ...
                                <div className='text-[#FAFAFA] font-bold leading-[19.07px] tracking-[-5%] text-[20px] self-center'>  ¿Seguro que deseas eliminar el rol?
                                </div>
                            ...
                            <div className='flex mt-[1rem]'>
                                ...
                                <div
                                    className="flex h-[48px] w-[136px] border-[2px] border-[#626262] bg-white/20 border-white/20 rounded-[10px] mr-[24px] ml-[9px] text-[16px]  
